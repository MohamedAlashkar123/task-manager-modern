...
-- This will drop existing tables and create new ones with correct structure
-- ⚠️  WARNING: This will delete all existing task/note/process data
-- Your user account will remain intact

-- ===========================================
-- DROP EXISTING TABLES (PRESERVES USER DATA)
-- ===========================================
...
-- Create rpa_processes table with all required columns
...
-- Insert a sample task for your user
INSERT INTO tasks (title, priority, completed, status, user_id) 
VALUES ('Welcome to Task Manager!', 'medium', false, 'Not Started', '4fdf45a4-55e2-48b5-9338-efa303b20063');

-- Insert a sample note for your user
INSERT INTO notes (title, content, user_id) 
VALUES ('Getting Started', 'Welcome to your task manager! You can create tasks, notes, and RPA processes here.', '4fdf45a4-55e2-48b5-9338-efa303b20063');

-- Insert a sample RPA process for your user
INSERT INTO rpa_processes (name, description, status, user_id) 
VALUES ('Sample Automation', 'This is an example RPA process to get you started.', 'active', '4fdf45a4-55e2-48b5-9338-efa303b20063');
...
-- SETUP COMPLETE
-- ===========================================
-- ✅ Fresh database created with correct structure
-- ✅ Sample data added for user: 4fdf45a4-55e2-48b5-9338-efa303b20063
